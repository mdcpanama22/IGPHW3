...
//Kingofjoys -- Matthew Carlson 
//Added outline to the shader 3/11/2019

Shader "Custom/SpaceOutline" {
	Properties{
	...
	_StereoDistance("Stereo Distance", Range(-5, 5)) = 0.5
		...
		_RimColor("RimColor", Color) = (1,0,0.5,1)
		_RimExponent("RimExponent", Float) = 5
		_RimGlow("RimGlow", Float) = 5
...
#include "UnityCG.cginc"
	...
	void surf(Input IN, inout SurfaceOutput o) {
		...
		o.Emission = float3(v *0.1) + (_RimColor.rgb * pow(rim, _RimExponent));
	}
